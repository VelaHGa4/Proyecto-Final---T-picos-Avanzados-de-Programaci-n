...
Nuestro proyecto está construido en Java apoyándose de interfaces gráficas y una base de datos en PostgressSQL. El proyecto engloba el registro, manejo y distribución de una tienda de reparación de electrónicos a partir de un sistema de interfaces los cuales son:
